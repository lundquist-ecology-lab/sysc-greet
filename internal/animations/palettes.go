...
func GetFirePalette(themeName string) []string {
	...
	case "paradise":
		return []string{
			"#151515", // Dark background
			"#424242", // Dark gray muted
			"#B66467", // Red (danger)
			"#D9BC8C", // Yellow (accent/warning)
			"#8C977D", // Green (primary)
			"#8DA3B9", // Blue (secondary)
			"#E8E3E3", // Light foreground (hottest)
		}
	default:
...
func GetMatrixPalette(themeName string) []string {
	...
	case "paradise":
		return []string{"#151515", "#424242", "#8DA3B9", "#8C977D", "#D9BC8C", "#E8E3E3"}
	default:
...
func GetParticlePalette(themeName string) []string {
	...
	case "paradise":
		return []string{"#8C977D", "#8DA3B9", "#D9BC8C", "#E8E3E3"}
	default:
...
func GetRainPalette(themeName string) []string {
	...
	case "transishardjob":
		return []string{"#55cdfc", "#f7a8b8", "#ffffff"}
	case "paradise":
		return []string{"#8DA3B9", "#8C977D", "#D9BC8C", "#E8E3E3"}
	default:
...
func GetFireworksPalette(themeName string) []string {
	...
	case "paradise":
		return []string{"#B66467", "#D9BC8C", "#8C977D", "#8DA3B9", "#E8E3E3", "#ffffff"}
	default:
...
func GetScreensaverPalette(themeName string) []string {
	...
	case "paradise":
		return []string{"#151515", "#8C977D", "#8DA3B9", "#D9BC8C", "#E8E3E3", "#E8E3E3"}
	default:
